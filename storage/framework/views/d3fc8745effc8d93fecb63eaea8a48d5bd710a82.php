...
<body class="flex flex-col justify-center items-center gap-2 m-8">
    ...
    <form action="<?php echo e(route('logicAbsensi')); ?>" method="POST" class="flex flex-col gap-2">
        <?php echo csrf_field(); ?>
        ...
        <div class="flex flex-col justify-center items-start gap-2;">
            ...
            <div class="flex flex-row justify-center items-center gap-4">
                <label for="tanggalMasuk1">
                    Tanggal Masuk
                    <input type="date" name="tanggalMasuk1" id="tanggalMasuk1" value="<?php echo e(old('tanggalMasuk1')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize"
                ...
                <label for="jamMasuk1">
                    Jam Masuk
                    <input type="time" name="jamMasuk1" id="jamMasuk1" value="<?php echo e(old('jamMasuk1')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamKeluar1">
                    Jam Keluar
                    <input type="time" name="jamKeluar1" id="jamKeluar1" value="<?php echo e(old('jamKeluar1')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="keterangan1">
                    Keterangan
                    <input type="text" name="keterangan1" id="keterangan1" value="<?php echo e(old('keterangan1')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-center items-start gap-2;">
            ...
            <div class="flex flex-row justify-center items-center gap-4">
                <label for="tanggalMasuk1">
                    Tanggal Masuk
                    <input type="date" name="tanggalMasuk2" id="tanggalMasuk2" value="<?php echo e(old('tanggalMasuk2')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamMasuk2">
                    Jam Masuk
                    <input type="time" name="jamMasuk2" id="jamMasuk2" value="<?php echo e(old('jamMasuk2')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamKeluar2">
                    Jam Keluar
                    <input type="time" name="jamKeluar2" id="jamKeluar2" value="<?php echo e(old('jamKeluar2')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="keterangan2">
                    Keterangan
                    <input type="text" name="keterangan2" id="keterangan2" value="<?php echo e(old('keterangan2')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-center items-start gap-2;">
            ...
            <div class="flex flex-row justify-center items-center gap-4">
                <label for="tanggalMasuk3">
                    Tanggal Masuk
                    <input type="date" name="tanggalMasuk3" id="tanggalMasuk3" value="<?php echo e(old('tanggalMasuk3')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamMasuk3">
                    Jam Masuk
                    <input type="time" name="jamMasuk3" id="jamMasuk3" value="<?php echo e(old('jamMasuk3')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamKeluar3">
                    Jam Keluar
                    <input type="time" name="jamKeluar3" id="jamKeluar3" value="<?php echo e(old('jamKeluar3')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="keterangan3">
                    Keterangan
                    <input type="text" name="keterangan3" id="keterangan3" value="<?php echo e(old('keterangan3')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>
            </div>
        </div>
            ...
            <div class="flex flex-row justify-center items-center gap-4">
                <label for="tanggalMasuk4">
                    ...
                    <input type="date" name="tanggalMasuk4" id="tanggalMasuk4"
                        value="<?php echo e(old('tanggalMasuk4')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamMasuk4">
                    Jam Masuk
                    <input type="time" name="jamMasuk4" id="jamMasuk4" value="<?php echo e(old('jamMasuk4')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamKeluar4">
                    Jam Keluar
                    <input type="time" name="jamKeluar4" id="jamKeluar4" value="<?php echo e(old('jamKeluar4')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="keterangan4">
                    Keterangan
                    <input type="text" name="keterangan4" id="keterangan4" value="<?php echo e(old('keterangan4')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>
            </div>
        </div>
            ...
            <div class="flex flex-row justify-center items-center gap-4">
                <label for="tanggalMasuk5">
                    ...
                    <input type="date" name="tanggalMasuk5" id="tanggalMasuk5"
                        value="<?php echo e(old('tanggalMasuk5')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamMasuk5">
                    Jam Masuk
                    <input type="time" name="jamMasuk5" id="jamMasuk5" value="<?php echo e(old('jamMasuk5')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="jamKeluar5">
                    Jam Keluar
                    <input type="time" name="jamKeluar5" id="jamKeluar5" value="<?php echo e(old('jamKeluar5')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>

                <label for="keterangan5">
                    Keterangan
                    <input type="text" name="keterangan5" id="keterangan5" value="<?php echo e(old('keterangan5')); ?>"
                        class="flex p-3 mt-2 border-2 w-64 border-blue-600 rounded-md capitalize">
                </label>
            </div>
        </div>
...
<?php /**PATH D:\Laravel-Okta\resources\views/boarding.blade.php ENDPATH**/ ?>