                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/absensi" class="underline text-gray-900 dark:text-white">Absensi Magang</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Silahkan klik untuk mengunjungi page absensi.
                                </div>
                            </div>
                        </div>
...
<?php /**PATH D:\Laravel-Okta\resources\views/welcome.blade.php ENDPATH**/ ?>